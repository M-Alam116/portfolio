export default function Experience() {
  return (
    <div className="w-full flex justify-center items-center mt-[2rem]">
      <div className="max-w-[480px] w-full bg-[#101624] px-[1.5rem] py-[2rem] border-[2px] border-primaryColor border-opacity-10 rounded-[10px] hover:border-secondaryColor transition-all duration-500">
